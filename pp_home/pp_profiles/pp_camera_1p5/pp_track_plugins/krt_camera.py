...
class krt_camera(object):
    ...
    def load(self,track_file,liveshow,track_type):
        ...
        # Can do three things:
        #   modify the track file or track file name that is about to be  loaded
    ...
    def show(self):
        ...
        # initialise the camera and allow time for it to warm up
        # looks like 500mS is adequate so set count to 0
        self.warm_up_count=0
        self.preview_started=False
        self.cam = PiCamera(sensor_mode=7)        
    ...
    def redraw(self):
        ...
        #camera init executed once after warmup
